...
@Component({
  selector: 'app-update-record-form-mfg',
  templateUrl: './update-record-form-mfg.component.html',
  styleUrls: ['./update-record-form-mfg.component.scss']
})
export class UpdateRecordFormMfgComponent implements OnInit {
  ...
  constructor(
    ...
    public ef: UpdateFormMfgService,
