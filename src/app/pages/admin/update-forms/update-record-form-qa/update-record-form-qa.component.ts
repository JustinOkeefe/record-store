...
@Component({
  selector: 'app-update-record-form-qa',
  templateUrl: './update-record-form-qa.component.html',
  styleUrls: ['./update-record-form-qa.component.scss']
})
export class UpdateRecordFormQaComponent implements OnInit {
  ...
  private _buildForm() {
    this.recordForm = this.fb.group({
      ...
      batchId: [this.formRecord.batchId, [
        //Validators.required,
        //Validators.minLength(this.ef.batchIdMin),
        //Validators.maxLength(this.ef.batchIdMax)
      ]],
      issuanceNumber: [this.formRecord.issuanceNumber, [
        //Validators.required,
        //Validators.minLength(this.ef.textMin),
        //Validators.maxLength(this.ef.issuanceNumMax)
      ]],
      processOrder: [this.formRecord.processOrder, [
        //Validators.required,
        //Validators.minLength(this.ef.processOrderMin),
        //Validators.maxLength(this.ef.processOrderMax)
      ]],
      ...
      mbrDocNumber: [this.formRecord.mbrDocNumber, [
        //Validators.required,
        //Validators.minLength(this.ef.textMin),
        //Validators.maxLength(this.ef.mbrDocNumMax)
      ]],
